#python while loop
#While loop executes block of code repeatedly as long as a certain conditionn is true. The syntax of a while loop in python is as follows
"""
Initializing aof a variable,
while keyword,
